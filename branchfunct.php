...
$date2 = date("Y-m");
$sql2 = "select sum(Sales_Volume) as sum1, sum(Invoice_Volume) as sum2, sum(Return_m) as sum3 from sales where Date like '$date2%'";
...
$date = date("$yr-$date3");
$sql3 = "select sum(Sales_Volume) as sum1, sum(Invoice_Volume) as sum2, sum(Return_m) as sum3 from sales where Date like '$date%'";
...
$datelast = date("Y-m-$date44",(strtotime ( '-0 month' , strtotime ($d) ) ));
									...
									$sql5 = "select sum(Sales_Volume) as sum1, sum(Invoice_Volume) as sum2, sum(Return_m) as sum3 from sales where Date Date BETWEEN '$date44444' AND '$datelast'";
...
$today = date("Y-m-d");
$sql = "select sum(Sales_Volume) as sum1, sum(Return_m) as sum3 from sales where Method = 'Cash' and Date = '$today'";
$result = mysqli_query($conn, $sql);
if ($result->num_rows > 0) {
	while ($row = $result->fetch_assoc()) {
...
$ajax = $ajax . "###" . $cashc;
$sql = "select sum(Sales_Volume) as sum1, sum(Return_m) as sum3 from sales where Method = 'Cheque' and Date = '$today'";
$result = mysqli_query($conn, $sql);
if ($result->num_rows > 0) {
	while ($row = $result->fetch_assoc()) {
...
$sql = "select sum(Sales_Volume) as sum1, sum(Return_m) as sum3 from sales where Method = 'Card' and Date = '$today'";
$result = mysqli_query($conn, $sql);
if ($result->num_rows > 0) {
	while ($row = $result->fetch_assoc()) {
...
$sql = "select sum(Sales_Volume) as sum1, sum(Return_m) as sum3 from sales where Method = 'Credit' and Date = '$today'";
$result = mysqli_query($conn, $sql);
if ($result->num_rows > 0) {
	while ($row = $result->fetch_assoc()) {
...
$ajax = $ajax . "###" . $creditc;
$date2 = date("Y-m-d");
	$sql4 = "select sum(Sales_Volume) as sum1, sum(Invoice_Volume) as sum2, sum(Return_m) as sum3 from sales where Date = '$date2'";
